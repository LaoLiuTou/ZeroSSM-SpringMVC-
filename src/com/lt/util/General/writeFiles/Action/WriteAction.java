...
public class WriteAction {
	...
	public  void createFiles(String dirs,String url,String tableName,String pKey) throws IOException{
        ...
        if(!file.exists()){
            ...
            sb.append("	private String callback;//跨域\n");
            sb.append("	@Autowired\n");
        	...
        	sb.append("	}\n");
        	sb.append("	public String getCallback() {\n");
        	sb.append("		return callback;\n");
        	sb.append("	}\n");
        	sb.append("	public void setCallback(String callback) {\n");
	...
	public  void addAddFunctionEnd(String tableName,String pKey) throws IOException{
		...
		sb.append("			msg.append("+tableName.toLowerCase()+".get"+toUpperCaseFirstOne(pKey.toLowerCase())+"()+\"\\\"\");\n");
		//sb.append("			response.getWriter().write(\"{\"\":\"\"}\"); \n"); 
		...
		sb.append("			response.getWriter().write(msg.toString());\n"); 
		sb.append("		}\n"); 
		sb.append("		else{\n"); 
		sb.append("			response.getWriter().write(callback+\"(\"+msg.toString()+\")\");\n"); 
		sb.append("		}\n"); 
	...
	public  void addListFunctionEnd(String tableName,String pKey) throws IOException{
		...
		sb.append("			}\n");
		sb.append("			});\n");
		sb.append("			msg.append(\"\\\"success\\\",\\\"count\\\":\\\"\"+totalnumber+\"\\\",\\\"msg\\\":\");\n");
	 ...
	 * @return
	 */
	public  void addAllFunctionStart(String tableName,String pKey) throws IOException{
		Logger log = Logger.getLogger("ZeroLog"); 
		String lowerName= toUpperCaseFirstOne(tableName.toLowerCase()) ;
		ProjectBean pb=new ProjectBean();
		String url=pb.getProjectUrl()+"/"+pb.getProjectName()+"/"+"src/com/"+pb.getProjectName().toLowerCase()
		...
		StringBuffer sb=new StringBuffer();
		sb.append("	@SuppressWarnings({ \"unchecked\", \"rawtypes\" })\n"); 
		sb.append("	public String all() throws Exception {\n\n"); 
		//sb.append("		size=15;\n"); 
		sb.append("		response.setContentType(\"text/html;charset=UTF-8\"); \n"); 
		sb.append("		Map  paramMap = new HashMap ();\n"); 
		out.write(sb.toString().getBytes("utf-8"));
	 ...
	 * @return
	 */
	public  void addAllFunctionEnd(String tableName,String pKey) throws IOException{
		Logger log = Logger.getLogger("ZeroLog"); 
		String lowerName= toUpperCaseFirstOne(tableName.toLowerCase()) ;
		ProjectBean pb=new ProjectBean();
		String url=pb.getProjectUrl()+"/"+pb.getProjectName()+"/"+"src/com/"+pb.getProjectName().toLowerCase()
		...
		sb.append("		try {\n"); 
		sb.append("			totalnumber=i"+lowerName+"Service.selectCount"+tableName+"ByParam(paramMap);\n"); 
		sb.append("			paramMap.put(\"fromPage\",0);\n"); 
		sb.append("			paramMap.put(\"toPage\",totalnumber);\n"); 
